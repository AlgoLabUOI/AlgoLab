...
if __name__ == '__main__':
	psnr_values1 = [0.009,0.009,0.009,0.009,0.009,0.009,0.009,0.009,0.009,0.009]
	psnr_values2 = [0.28,0.29,0.29,0.29,0.31,0.25,0.27,0.27,0.31,0.31]
	#psnr_values1 = [0.98,0.99,0.99,0.99,0.99]
	#psnr_values2 = [0.98,0.99,0.99,0.99,0.99]
	#images = ["w_sky","w_winter"]
	images = ["40_cols","40_rows","64x64_white","64x64_black","128_cols","128_rows","256x256_white","256x256_black","350x350_white","350x350_black"]
