...
from BER import calculate_C,similarity,similaritysip
...
def testAttack():
	if(MODEL == 'key'):
		...
		if(ATTACK == 'crop'):
			...
			KEY = "no key"
			COPT = "no c"
			SECRET_PAIRS = [((2,0), (2, 1)), ((2, 2), (2, 3)), ((2, 4), (2, 5)), ((2, 6), (2, 7)), ((3, 0), (3, 1)), ((3, 2), (3, 3)), ((3, 4), (3, 5)), ((3, 6), (3, 7)), 
			...
			if(ARG3 == "cols" or ARG3 == "rows"):
				path3 = "M:\\BSc-Watermarking\\code\\attack_model\\charts\\geometric_charts\\" + IMAGE_NAME + "\\(11,1)\\intresting_cases\\" + ARG1 + "_" + ARG3 +  "\\logo1" + str("") + ".png"
				path4 = "M:\\BSc-Watermarking\\code\\attack_model\\charts\\geometric_charts\\" + IMAGE_NAME + "\\(11,1)\\intresting_cases\\" + ARG1 + "_" + ARG3 +"\\logo2" + str("") + ".png"
				#path5 = "M:\\BSc-Watermarking\\code\\attack_model\\charts\\geometric_charts\\512x512\\" + IMAGE_NAME + "\\(7,1)\\casual_cases\\" + ARG1 + "_" + ARG3 +"\\" + IMAGE_NAME + ".png"
			if(ARG3 == "white" or ARG3 == "black"):
				path3 = "M:\\BSc-Watermarking\\code\\attack_model\\charts\\geometric_charts\\" + IMAGE_NAME + "\\(11,1)\\intresting_cases\\" + ARG1 + "x" + ARG2 + "_" + ARG3 +  "\\logo1" + str("") + ".png"
				path4 = "M:\\BSc-Watermarking\\code\\attack_model\\charts\\geometric_charts\\" + IMAGE_NAME + "\\(11,1)\\intresting_cases\\" + ARG1 + "x" + ARG2 + "_" + ARG3 +"\\logo2" + str("") + ".png"
			...
			print("percentage of modified pixel values per channel: ",len(SECRET_PAIRS) / 64)
			im = embed(IMAGE,8,LOGO_1,LOGO_2,rep)
			path = attack_model.attackImage(im,ATTACK,[ARG1,(ARG2,ARG3)],KEY,COPT,MODEL)
			lg1,lg2 = extractLogoFromImage(path,8,SECRET_PAIRS,rep)
			...
			if(ARG1 == "gamma"):
				...
				path3 = "M:\\BSc-Watermarking\\code\\attack_model\\charts\\filter_charts\\" + ARG1 + "\\logos\\" + ARG1 + "(" + ARG3 +")\\" + "\\512x512\\" + IMAGE_NAME +"\\logo1" + str("") + ".png"
				path4 = "M:\\BSc-Watermarking\\code\\attack_model\\charts\\filter_charts\\" + ARG1 + "\\logos\\" + ARG1 + "(" + ARG3 +")\\" + "\\512x512\\" + IMAGE_NAME +"\\logo2" + str("") + ".png"
			else:
				path3 = "M:\\BSc-Watermarking\\code\\attack_model\\charts\\compression_charts\\" + IMAGE_NAME + "\\512x512\\" + ARG1 +"\\logo1.png"
				path4 = "M:\\BSc-Watermarking\\code\\attack_model\\charts\\compression_charts\\" + IMAGE_NAME + "\\512x512\\" + ARG1 +"\\logo2.png"
			im1.save(path3,quality=100,subsampling=0)
			im2.save(path4,quality=100,subsampling=0)
